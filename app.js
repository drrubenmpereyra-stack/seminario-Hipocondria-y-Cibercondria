...
function mostrarPantallaLoginAdmin(mensajeError = '') {
    ...
    `;
    const btnAdmin = document.getElementById('btnIngresarAdmin');
    if (btnAdmin) btnAdmin.onclick = verificarLoginAdmin;
}
...
function mostrarPantallaLoginParticipante(mensajeError = '') {
    ...
    `;
    const btnPart = document.getElementById('btnIngresarPart');
    if (btnPart) btnPart.onclick = verificarLoginParticipante;
}
...
async function verificarLoginParticipante() {
    ...
    try {
        ...
        mostrarPantallaLoginParticipante('Error al conectar con la base de datos. Verifique su conexión.');
    }
}
